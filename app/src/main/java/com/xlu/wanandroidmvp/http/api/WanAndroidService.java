package com.xlu.wanandroidmvp.http.api;
...
import com.xlu.wanandroidmvp.http.bean.CoinHistory;
import com.xlu.wanandroidmvp.http.bean.HotKey;
import com.xlu.wanandroidmvp.http.bean.Navi;
import com.xlu.wanandroidmvp.http.bean.PageInfo;
import com.xlu.wanandroidmvp.http.bean.ShareUserArticles;
import com.xlu.wanandroidmvp.http.bean.Tab;
import com.xlu.wanandroidmvp.http.bean.Todo;
import com.xlu.wanandroidmvp.http.bean.Website;
...
public interface WanAndroidService {
     ...
     * https://www.wanandroid.com/user/login?username=xlu233&password=as13677291420as
     * @return
     */
    @POST("user/login")
    @FormUrlEncoded
    ...
    @POST("user/register")
    @FormUrlEncoded
    Observable<WanAndroidResponse<UserData>> register(@Field("username") String username, @Field("password") String password, @Query("repassword") String repassword);
